...
locale = {
  ...
  translation = {
    ...
    ["Hide pokemons"] = "Ocultar monstruos",
    ...
    ["Hide moves for higher exp. levels"] = "Ocultar hechizos para niveles m�s altos que tu experiencia.",
    ["Hide moves for other vocations"] = "Ocultar hechizos que sean para otra vocaci�n",
    ...
    ["Special"] = "Especial",
    ["Speed"] = "Velocidad",
    ["Move Cooldowns"] = "Enfriamiento de hechizos", --Should 'moves'? be an unique name?
    ["Move List"] = "Lista de hechizos",
    ["Stamina"] = "Resistencia",
