locale = {
  ...
  translation = {
    ...
    ["Hide pokemons"] = "Esconder montros",
    ...
    ["Hide moves for higher exp. levels"] = "Esconder feiti�os de n�vel maior",
    ...
    ["Select all"] = false,
    ["Select pokemon"] = "Selecione o monstro",
    ...
    ["Turn north"] = "Virar para o norte",
    ["Turn east"] = "Virar para o leste",
    ["Turn south"] = "Virar para o sul",
    ["Turn west"] = "Virar para o oeste",
    ["Face north without moving."] = "Olhar para o norte sem andar.",
    ["Face east without moving."] = "Olhar para o leste sem andar.",
    ["Face south without moving."] = "Olhar para o sul sem andar.",
    ["Face west without moving."] = "Olhar para o oeste sem andar.",
    ...
    ["You don't may receive experience and loot from pokemons"] = "Voc� talvez n�o possa receber experiencia e loot dos monstros",
    ...
    ["You"] = "Voce",
    ["Other player"] = "Outro jogador",
    ["Editing offer"] = "Editando oferta",
    ["Items confirmed"] = "Itens confirmados",
    ["Backpack"] = "Mochila",
    ["Up"] = "Subir",
    ["Previous"] = "Anterior",
    ["Next"] = "Proxima",
    ["Drag an item to your offer, or double-click it below."] = "Arraste um item para sua oferta ou clique duas vezes nele abaixo.",
    ["Double-click an item to offer it. Double-click a container to open it."] = "Clique duas vezes em um item para oferece-lo. Clique duas vezes em um container para abri-lo.",
    ["Amount to offer"] = "Quanto deseja oferecer",
    ["Your balance: %s"] = "Seu saldo: %s",
    ["Money offered"] = "Dinheiro oferecido",
    ["Amount offered: %s"] = "Valor oferecido: %s",
    ["Trade item amount"] = "Quantidade do item na troca",
    ["Confirm items"] = "Confirmar itens",
    ["Confirmed"] = "Confirmado",
    ["Accept trade"] = "Aceitar troca",
    ["Waiting for player"] = "Aguardando jogador",
    ["Cancel trade"] = "Cancelar troca",
    ["Trade invitation"] = "Convite de troca",
    ["%s wants to trade with you."] = "%s quer trocar com voce.",
    ["Trade with %s"] = "Trocar com %s",
    ["Accept"] = "Aceitar",
    ["Reject"] = "Recusar",
    ["Account creation"] = "Criacao de conta",
    ["Account created successfully."] = "Conta criada com sucesso.",
    ["Account creation is currently disabled."] = "A criacao de contas esta desativada no momento.",
    ["Account name must contain 4 to 32 letters or numbers."] = "O nome da conta deve ter de 4 a 32 letras ou numeros.",
    ["Character creation"] = "Criacao de personagem",
    ["Character created successfully."] = "Personagem criado com sucesso.",
    ["Character creation is currently disabled."] = "A criacao de personagens esta desativada no momento.",
    ["Character name"] = "Nome do personagem",
    ["Character name must contain 3 to 20 letters and single spaces."] = "O nome deve ter de 3 a 20 letras, com apenas um espaco entre palavras.",
    ["Confirm password"] = "Confirmar senha",
    ["Could not create the account. Please try another name."] = "Nao foi possivel criar a conta. Tente outro nome.",
    ["Could not create the character. Please try another name."] = "Nao foi possivel criar o personagem. Tente outro nome.",
    ["Create"] = "Criar",
    ["Create account"] = "Criar conta",
    ["Create character"] = "Criar personagem",
    ["Creating account..."] = "Criando conta...",
    ["Creating character..."] = "Criando personagem...",
    ["Female"] = "Feminino",
    ["Invalid authenticator token."] = "Token de autenticacao invalido.",
    ["Invalid character sex."] = "Sexo do personagem invalido.",
    ["Male"] = "Masculino",
    ["No starting town is configured."] = "Nenhuma cidade inicial esta configurada.",
    ["Password must contain 6 to 29 characters."] = "A senha deve ter de 6 a 29 caracteres.",
    ["Passwords do not match."] = "As senhas nao conferem.",
    ["Please wait before creating another account."] = "Aguarde antes de criar outra conta.",
    ["Sex"] = "Sexo",
    ["This account has reached its character limit."] = "Esta conta atingiu o limite de personagens.",
    ["This account name is already in use."] = "Este nome de conta ja esta em uso.",
    ["This character name is already in use."] = "Este nome de personagem ja esta em uso.",
    ["Use 4-32 letters or numbers for the account name."] = "Use de 4 a 32 letras ou numeros no nome da conta.",
  }
}
